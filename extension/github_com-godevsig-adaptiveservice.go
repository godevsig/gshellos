...
func init() {
	Symbols["github.com/godevsig/adaptiveservice/adaptiveservice"] = map[string]reflect.Value{
		...
		"TraceMsgByNameWithCount": reflect.ValueOf(adaptiveservice.TraceMsgByNameWithCount),
		"TraceMsgByType":          reflect.ValueOf(adaptiveservice.TraceMsgByType),
		"TraceMsgByTypeWithCount": reflect.ValueOf(adaptiveservice.TraceMsgByTypeWithCount),
