...
func init() {
	BuiltinSymbols["github.com/godevsig/adaptiveservice/adaptiveservice"] = map[string]reflect.Value{
		...
		"Capacity":                  reflect.ValueOf(adaptiveservice.Capacity),
		"DefaultQSizePerCore":       reflect.ValueOf(adaptiveservice.DefaultQSizePerCore),
		"DefaultQWeight":            reflect.ValueOf(adaptiveservice.DefaultQWeight),
		...
		"Invalid":                   reflect.ValueOf(adaptiveservice.Invalid),
		"Latency":                   reflect.ValueOf(adaptiveservice.Latency),
		...
		"MsgQInfo":                reflect.ValueOf((*adaptiveservice.MsgQInfo)(nil)),
		"Netconn":                 reflect.ValueOf((*adaptiveservice.Netconn)(nil)),
		"Option":                  reflect.ValueOf((*adaptiveservice.Option)(nil)),
		"ProviderSelectionMethod": reflect.ValueOf((*adaptiveservice.ProviderSelectionMethod)(nil)),
		"QueryMsgQInfo":           reflect.ValueOf((*adaptiveservice.QueryMsgQInfo)(nil)),
