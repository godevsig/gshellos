// Code generated by 'yaegi extract github.com/godevsig/grepo/lib/sys/pidinfo'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/godevsig/grepo/lib/sys/pidinfo/pidinfo"] = map[string]reflect.Value{
