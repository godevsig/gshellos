...
type _go_ast_Decl struct {
	IValue interface{}
	WEnd   func() (r0 token.Pos)
	WPos   func() (r0 token.Pos)
}

func (W _go_ast_Decl) End() (r0 token.Pos) {
	if W.WEnd == nil {
		return
	}
	return W.WEnd()
}
func (W _go_ast_Decl) Pos() (r0 token.Pos) {
	if W.WPos == nil {
		return
	}
	return W.WPos()
...
func (W _go_ast_Expr) End() (r0 token.Pos) {
	if W.WEnd == nil {
		return
	}
	return W.WEnd()
}
func (W _go_ast_Expr) Pos() (r0 token.Pos) {
	if W.WPos == nil {
		return
	}
	return W.WPos()
...
func (W _go_ast_Node) End() (r0 token.Pos) {
	if W.WEnd == nil {
		return
	}
	return W.WEnd()
}
func (W _go_ast_Node) Pos() (r0 token.Pos) {
	if W.WPos == nil {
		return
	}
	return W.WPos()
...
func (W _go_ast_Spec) End() (r0 token.Pos) {
	if W.WEnd == nil {
		return
	}
	return W.WEnd()
}
func (W _go_ast_Spec) Pos() (r0 token.Pos) {
	if W.WPos == nil {
		return
	}
	return W.WPos()
...
func (W _go_ast_Stmt) End() (r0 token.Pos) {
	if W.WEnd == nil {
		return
	}
	return W.WEnd()
}
func (W _go_ast_Stmt) Pos() (r0 token.Pos) {
	if W.WPos == nil {
		return
	}
	return W.WPos()
