...
// +build go1.16,!go1.17,stdcompress
...
func (W _compress_flate_Reader) ReadByte() (r0 byte, r1 error) {
	if W.WReadByte == nil {
		return
	}
	return W.WReadByte()
...
func (W _compress_flate_Resetter) Reset(r io.Reader, dict []byte) (r0 error) {
	if W.WReset == nil {
		return
	}
